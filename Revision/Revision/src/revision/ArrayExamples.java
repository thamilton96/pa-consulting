...
public class ArrayExamples {
	...
	public static void main(String[] args) {
		...
		arrayExamples.isEmptyArray();
		
		arrayExamples.containsString();
		
		ArrayList<String> arrays = arrayExamples.containsString2();
	...
	public ArrayList<String> containsString2() {
		
		ArrayList<String> containsString2 = new ArrayList();
		
		containsString2.add("Good");
		containsString2.add("Morning");
		
		return containsString2("Good");
	}
	...
	public void isEmptyArray() {
		...
		listOfStuff.isEmpty("Is it empty:" + listOfStuff.empty);
	}
}