...
public class Animal {
	...
	public static void main(String[] args) {
		...
		System.out.println("List of array after removing dog and cat: " + listOfAnimalsLess);

		ArrayList<String> emptyAnimals = animal.removeAllAnimals();
		
		System.out.println("List of array after removing all animals: " + emptyAnimals);
	...
	/**
	 * Removes all animals from the array and prints empty list
	 */
